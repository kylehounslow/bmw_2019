...
class YOLO(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.classes_path = os.path.join(this_dir, 'model_data/coco_classes.txt')
        self.anchors_path = os.path.join(this_dir, 'model_data/yolo_anchors.txt')
        self.model_path = os.path.join(this_dir, 'model_data/yolo.h5')
    ...
    def _maybe_download_weights(self):
        ...
        if not os.path.exists(self.model_path):
            ...
            gdd.download_file_from_google_drive(file_id=self.weights_file_id, dest_path=self.model_path,
                                                overwrite=True)
            print("Done.")
